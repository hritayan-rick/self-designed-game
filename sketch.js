...
var waterballImage  , waterballGroup , waterballSprite;
var swordGroup , swordSprite , swordImage;
var score = 0;
var gameState = "serve";
...
function preload(){
  ...
  swordImage = loadImage("image/sword.png")
  waterballImage = loadImage("image/waterball.png")
...
function draw(){
  ...
  if(gameState ==="play" ){
    ...
    if(swordGroup.isTouching(monGroup)){
    ...
    if(waterballGroup.isTouching(fireballGroup)){
...
function createwaterball(){
     ...
     waterballSprite =  createSprite(1220 , 100 , 34 , 87);
     waterballSprite.addImage(waterballImage);
    
   
  
     waterballSprite.y = soldier.y;
     waterballSprite.x = soldier.x;

     waterballSprite.velocityX =4;
     waterballSprite.scale = 0.2;

     
    
     waterballSprite.lifetime = 430;
      waterballGroup.add(waterballSprite);
  }


function createSword(){
 
     swordSprite =  createSprite(1220 , 100 , 34 , 87);
     swordSprite.addImage(swordImage);
    
    
  
     swordSprite.y = soldier.y;
     swordSprite.x = soldier.x;

     swordSprite.velocityX =4; 
     swordSprite.scale = 0.2;

     
    
     swordSprite.lifetime = 430;
